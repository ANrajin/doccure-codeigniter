                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="<?php echo base_url('assets/base/img/doctors/doctor-thumb-01.jpg') ?>" alt="User Image">
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="<?php echo base_url('assets/base/img/doctors/doctor-thumb-02.jpg') ?>" alt="User Image">
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="<?php echo base_url('assets/base/img/doctors/doctor-thumb-03.jpg') ?>" alt="User Image">
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="<?php echo base_url('assets/base/img/doctors/doctor-thumb-04.jpg') ?>" alt="User Image">
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="<?php echo base_url('assets/base/img/doctors/doctor-thumb-05.jpg') ?>" alt="User Image">
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="<?php echo base_url('assets/base/img/doctors/doctor-thumb-06.jpg') ?>" alt="User Image">
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="<?php echo base_url('assets/base/img/doctors/doctor-thumb-07.jpg') ?>" alt="User Image">
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="<?php echo base_url('assets/base/img/doctors/doctor-thumb-08.jpg') ?>" alt="User Image">
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="<?php echo base_url('assets/base/img/doctors/doctor-thumb-09.jpg') ?>" alt="User Image">
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img rounded-circle" src="<?php echo base_url('assets/base/img/doctors/doctor-thumb-10.jpg') ?>" alt="User Image">
                                                </a>
